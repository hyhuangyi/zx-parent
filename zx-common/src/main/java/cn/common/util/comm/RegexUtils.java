...
public class RegexUtils {
    ...
    public static boolean checkPassword(String password) {
        String regex = "(?!([a-zA-Z]+|[a-z\\d]+|[a-z~`@#\\$%\\^&\\*\\(\\)_\\-\\+=\\{\\[\\}\\]\\|\\\\:;\\\"\\'<,>\\.\\?\\/\\!]+|[A-Z\\d]+|[A-Z~`@#\\$%\\^&\\*\\(\\)_\\-\\+=\\{\\[\\}\\]\\|\\\\:;\\\"\\'<,>\\.\\?\\/\\!]+|[\\d~`@#\\$%\\^&\\*\\(\\)_\\-\\+=\\{\\[\\}\\]\\|\\\\:;\\\"\\'<,>\\.\\?\\/\\!]+)$)[a-zA-Z\\d~`@#\\$%\\^&\\*\\(\\)_\\-\\+=\\{\\[\\}\\]\\|\\\\:;\\\"\\'<,>\\.\\?\\/\\!]{8,20}";
     ...
     * @return
     */
    public static boolean checkSmsSign(String smsSign) {
        String regex = "[0-9a-zA-Z\\u4e00-\\u9fa5]{2,10}";
        return Pattern.matches(regex,smsSign);
    }
...
//        String regex="^((-1|\\d{1,3})(,(-1|\\d{1,3}))*)?$";
//        System.out.println( Pattern.matches(regex, "-1,18"));
        System.out.println(checkIdCard("360732199407072113"));
    }*/
}
