...
public class Base64Utils {
    private static Log logger = LogFactory.getLog(Base64Utils.class);
    /**
     * BASE64字符串解码为二进制数据
     * @param base64
     * @return
     ...
     * @return
     */
    public static String encodeImageToBase64(BufferedImage bufferedImage) {// 将图片文件转化为字节数组字符串，并对其进行Base64编码处理
    ...
    public static String convert(String targetStr) {
        byte[] value;
        try {
            value = targetStr.getBytes("UTF-8");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String resFile = "D:/" + UUID.randomUUID() + ".jpg";
