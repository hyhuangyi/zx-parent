...
public class SysServiceImpl implements ISysService {
    ...
    public static final String XUE_QIU_V2 = "https://xueqiu.com/service/v5/stock/screener/quote/list?page={0}&size=100&order={1}&order_by=current_year_percent&market=CN&type=sh_sz";
