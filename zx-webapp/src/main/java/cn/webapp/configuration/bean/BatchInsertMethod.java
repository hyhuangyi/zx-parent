...
public class BatchInsertMethod extends AbstractMethod {
    ...
    private final static String BATCH_INSERT_SQL = "<script> INSERT INTO %s (%s) %s</script>";

    private final static String METHOD = "insertBatch";
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addMappedStatement(mapperClass, METHOD, sqlSource,
    ...
    private String getBatchInsertSql(TableInfo tableInfo, Class<?> modelClass) {
        String batchInsertSql = BATCH_INSERT_SQL;
        ...
        //如果是非oracle数据库
            ...
            foreachSql = "values" +
                    " <foreach collection=\"list\" item='item'  open='' index='index' separator=','>\n" +
                    "(%s,%s)</foreach>";
